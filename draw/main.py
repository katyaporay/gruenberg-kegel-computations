...
def create_aut_graph(group_name):
    """Creates image in folder graphs with Gruenberg-Kegel graph of automorphism group of {group_name}"""
...
def create_graph(group_name):
    """Creates image in folder graphs with Gruenberg-Kegel graph of group {group_name}"""
...
def create_cands_graph(group_name):
    """Creates images of all candidates listed in cands_by_group[{group_name}] and
    saves them in folder cands/{group_name}"""
